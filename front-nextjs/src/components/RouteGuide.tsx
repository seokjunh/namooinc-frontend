...
const RouteGuide = () => {
  return (
    <div className="py-[6.25rem]">
      <div className="mx-auto max-w-xs pt-16 md:max-w-xl lg:max-w-6xl">
        <div className="mb-b mb-[5rem] text-center text-2xl font-bold underline underline-offset-[1rem] sm:text-4xl">
          오시는 길
        </div>
        <div>
          <KakaoMap />
