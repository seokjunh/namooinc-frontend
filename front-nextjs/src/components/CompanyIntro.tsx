  ...
  return (
    <div className="py-[6.25rem]">
      <div className="relative flex h-44 items-center justify-center bg-slate-700 sm:h-64">
        <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 text-2xl font-bold text-white md:text-4xl">
          나무아이앤씨 소개
        </div>
      </div>
      <div className="mx-auto max-w-xs space-y-10 sm:space-y-14 py-14 text-lg sm:py-28 md:max-w-xl lg:max-w-5xl">
        <div className="space-y-14">
          <div className="space-y-6 text-center">
            <div className="text-3xl font-bold md:text-4xl lg:text-5xl">
              Connecting Values
            </div>
            <div className="text-lg font-semibold sm:justify-center md:text-2xl lg:flex lg:text-3xl">
